...
def print_report_info(results):
  ...
  str_list = []
  str_list.append('Report Infos:')
  str_list.append('Contains Sampled Data = %s' % results.get('containsSampledData'))
  str_list.append('Kind                  = %s' % results.get('kind'))
  str_list.append('ID                    = %s' % results.get('id'))
  str_list.append('Self Link             = %s' % results.get('selfLink'))
